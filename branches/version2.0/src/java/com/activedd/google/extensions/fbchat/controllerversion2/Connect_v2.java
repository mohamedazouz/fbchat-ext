 ...
 */
package com.activedd.google.extensions.fbchat.controllerversion2;
...
import com.activedd.google.extensions.fbchat.chatversion2.ChatProxyClient_v2;
...
public class Connect_v2 extends MultiActionController {
    ...
    private ChatProxyClient_v2 chatClient;
   ...
   // private JsonCreate jsonCreator;
    ...
    public void connect(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            chatClient = new ChatProxyClient_v2(configuration.getConfiguration(), realPath);
            ...
            if (request.getParameter("sessionkey") != null) {
                ...
                try {
                    ...
                    if (result.getInt("status") == 1) {
                        ...
                        message = "success";
                        userFileName=chatClient.getUserID();
                    } else {
            ...
            jSONObject = new JSONObject("{status:" + status + ",message:" + message + ",file:" + userFileName + "}");
    ...
    public void disconnect(HttpServletRequest request, HttpServletResponse response) {
        ...
        chatClient = (ChatProxyClient_v2) session.getAttribute("client");
        if (chatClient != null) {
