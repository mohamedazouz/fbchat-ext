...
import com.activedd.google.extensions.fbchat.chat.FacebookConnectSASLMechanism;
import com.activedd.google.extensions.fbchat.chat.JsonCreate;
import com.activedd.google.extensions.fbchat.chat.PacketFilterImp;
import java.util.*;
import java.io.*;
 ...
 * @
 */
public final class ChatProxyClient_v2 {
    ...
    private PacketListenerImp_v2 packetListenerImp;//listen for incomming messages and store in user file.
    private Timer SchTimer; //timer thread for lossing session;s
    int sessionTimeOut = 4;
    private String realPath;
    private String userID;

    public ChatProxyClient_v2(ConnectionConfiguration config, String realPath) {
        connection = new XMPPConnection(config);
        packetFilterImpl = new PacketFilterImp();
        JsonCreate_v2 jsonCreate = new JsonCreate_v2();
        jsonCreate.setRealPath(realPath);
        packetListenerImp = new PacketListenerImp_v2(jsonCreate);
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        ChatProxyClient_v2 chatProxyClient = new ChatProxyClient_v2(config, "/home/ibrahim/Desktop/");
