...
/***************************************************************************
version 101 
based on message listen which should send empty message to every one in friend list to open connection
and let message listener to listen messages from all friend 
