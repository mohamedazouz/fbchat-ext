...
public class ChatClient implements MessageListener {
    ...
    public void login(String token) throws XMPPException, InterruptedException, FacebookException {
        ...
        try {
            ...
            //facebook.(true);
            //facebook.isDesktop(false);

            facebook.isDesktop();
            //FacebookJsonRestClient frc = new FacebookJsonRestClient(apiKey, apiSecret);
            FB_SESSION_KEY = facebook.auth_getSession(token, true);
            FacebookJsonRestClient facebook2 = new FacebookJsonRestClient(apiKey, apiSecret, FB_SESSION_KEY);
            facebook2.users_getLoggedInUser();
            //String temp = FB_SESSION_KEY.substring(0,FB_SESSION_KEY.indexOf("_")) +FB_SESSION_KEY.substring(FB_SESSION_KEY.indexOf("-")-1);
